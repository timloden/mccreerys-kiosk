...
var FlexMasonry = function (e) {
  ...
  function f(e) {
    var n = e.querySelectorAll(".flexmasonry-break");
    if (Array.from(n).length !== d() - 1) for (var _n = 1; _n < d(); _n++) {
      var _t = document.createElement("div");

      _t.classList.add("flexmasonry-break"), _t.classList.add("flexmasonry-break-" + _n), e.appendChild(_t);
    }
  }
  ...
  function d() {
    ...
    var e = Object.keys(i.breakpointCols);

    for (var _i = 0, _e = e; _i < _e.length; _i++) {
      var _n2 = _e[_i];
      if (window.matchMedia("(" + _n2 + ")").matches) return i.breakpointCols[_n2];
    }
