...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = t(require("./foundation.core"), require("./foundation.util.keyboard"), require("./foundation.util.mediaQuery"), require("./foundation.util.motion"), require("./foundation.util.touch"), require("jquery")) : "function" == typeof define && define.amd ? define(["./foundation.core", "./foundation.util.keyboard", "./foundation.util.mediaQuery", "./foundation.util.motion", "./foundation.util.touch", "jquery"], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports["foundation.reveal"] = t(require("./foundation.core"), require("./foundation.util.keyboard"), require("./foundation.util.mediaQuery"), require("./foundation.util.motion"), require("./foundation.util.touch"), require("jquery")) : (e.__FOUNDATION_EXTERNAL__ = e.__FOUNDATION_EXTERNAL__ || {}, e.__FOUNDATION_EXTERNAL__["foundation.reveal"] = t(e.__FOUNDATION_EXTERNAL__["foundation.core"], e.__FOUNDATION_EXTERNAL__["foundation.util.keyboard"], e.__FOUNDATION_EXTERNAL__["foundation.util.mediaQuery"], e.__FOUNDATION_EXTERNAL__["foundation.util.motion"], e.__FOUNDATION_EXTERNAL__["foundation.util.touch"], e.jQuery));
}(window, function (i, n, o, s, r, a) {
  return function (i) {
    var n = {};
    ...
    "./foundation.core": function foundationCore(e, t) {
      e.exports = i;
    },
    "./foundation.util.keyboard": function foundationUtilKeyboard(e, t) {
      e.exports = n;
    },
    "./foundation.util.mediaQuery": function foundationUtilMediaQuery(e, t) {
      e.exports = o;
    },
    "./foundation.util.motion": function foundationUtilMotion(e, t) {
      e.exports = s;
    },
    "./foundation.util.touch": function foundationUtilTouch(e, t) {
      e.exports = r;
    },
    "./js/entries/plugins/foundation.reveal.js": function jsEntriesPluginsFoundationRevealJs(e, t, i) {
      "use strict";
      ...
      var o = i("./js/foundation.reveal.js");
      i.d(t, "Reveal", function () {
        return o.Reveal;
      }), n.Foundation.plugin(o.Reveal, "Reveal");
    },
    "./js/foundation.reveal.js": function jsFoundationRevealJs(e, t, i) {
      "use strict";
      ...
      var g = function (e) {
        ...
        return function (e, t) {
          ...
          value: function value(e, t) {
            this.$element = e, this.options = r.a.extend({}, i.defaults, this.$element.data(), t), this.className = "Reveal", this._init(), u.Triggers.init(r.a), a.Keyboard.register("Reveal", {
              ESCAPE: "close"
            });
          }
        }, {
          ...
          value: function value() {
            ...
            l.MediaQuery._init(), this.id = this.$element.attr("id"), this.isActive = !1, this.cached = {
              ...
              "data-resize": this.id
            }), this.$overlay ? this.$element.detach().appendTo(this.$overlay) : (this.$element.detach().appendTo(r()(this.options.appendTo)), this.$element.addClass("without-overlay")), this._events(), this.options.deepLink && window.location.hash === "#".concat(this.id) && (this.onLoadListener = Object(s.onLoad)(r()(window), function () {
              return e.open();
            }));
          }
        }, {
          ...
          value: function value() {
            var e,
                ...
                o = r()(window).height(),
                s = null;
            e = "auto" === this.options.hOffset ? parseInt((i - t) / 2, 10) : parseInt(this.options.hOffset, 10), "auto" === this.options.vOffset ? s = o < n ? parseInt(Math.min(100, o / 10), 10) : parseInt((o - n) / 4, 10) : null !== this.options.vOffset && (s = parseInt(this.options.vOffset, 10)), null !== s && this.$element.css({
              top: s + "px"
          ...
          value: function value() {
            ...
            this.$element.on({
              ...
              "close.zf.trigger": function closeZfTrigger(e, t) {
          ...
          key: "_disableScroll",
          value: function value(e) {
            e = e || r()(window).scrollTop(), r()(document).height() > r()(window).height() && r()("html").css("top", -e);
          }
        }, {
          key: "_enableScroll",
          value: function value(e) {
            e = e || parseInt(r()("html").css("top")), r()(document).height() > r()(window).height() && (r()("html").css("top", ""), r()(window).scrollTop(-e));
          }
        }, {
          key: "open",
          value: function value() {
            var e = this,
                t = "#".concat(this.id);
            this.options.deepLink && window.location.hash !== t && (window.history.pushState ? this.options.updateHistory ? window.history.pushState({}, "", t) : window.history.replaceState({}, "", t) : window.location.hash = t), this.$activeAnchor = r()(document.activeElement).is(this.$anchor) ? r()(document.activeElement) : this.$anchor, this.isActive = !0, this.$element.css({
              visibility: "hidden"
          ...
          value: function value() {
            ...
            this.$element.on("resizeme.zf.trigger.revealScrollbarListener", function () {
              return e();
            }), e(), r()("html").addClass("is-reveal-open");
          }
        }, {
          ...
          value: function value() {
            var t = this;
            this.$element && (this.focusableElements = a.Keyboard.findFocusable(this.$element), this.options.overlay || !this.options.closeOnClick || this.options.fullScreen || r()("body").on("click.zf.reveal", function (e) {
          ...
          value: function value() {
            ...
            function e() {
              ...
              0 === r()(".reveal:visible").length && t._removeGlobalClasses(), a.Keyboard.releaseFocus(t.$element), t.$element.attr("aria-hidden", !0), t._enableScroll(e), t.$element.trigger("closed.zf.reveal");
            }

            if (this.options.animationOut ? (this.options.overlay && c.Motion.animateOut(this.$overlay, "fade-out"), c.Motion.animateOut(this.$element, this.options.animationOut, e)) : (this.$element.hide(this.options.hideDelay), this.options.overlay ? this.$overlay.hide(0, e) : e()), this.options.closeOnEsc && r()(window).off("keydown.zf.reveal"), !this.options.overlay && this.options.closeOnClick && r()("body").off("click.zf.reveal"), this.$element.off("keydown.zf.reveal"), this.options.resetOnClose && this.$element.html(this.$element.html()), this.isActive = !1, t.options.deepLink && window.location.hash === "#".concat(this.id)) if (window.history.replaceState) {
    ...
    "./js/foundation.util.triggers.js": function jsFoundationUtilTriggersJs(e, t, i) {
      "use strict";
      ...
      u.Listeners.Basic = {
        ...
        closeMeListener: function closeMeListener(e, t) {
          ...
          s()("[data-".concat(i, "]")).not('[data-yeti-box="'.concat(t, '"]')).each(function () {
            var e = s()(this);
